...
def insert_sample_data(cursor):
    ...
    cursor.executemany('''
    INSERT INTO core_data (index_code, etf_code, mutual_code, support_level, normal_level, pressure_level, sell_level, other_level)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    ''', core_data)
